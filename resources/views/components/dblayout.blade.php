        ...
        <div class="flex h-screen w-64 flex-col justify-between border-e border-gray-200 bg-white sticky top-0">
            <div class="px-4 py-6">
                ...
                <ul class="mt-6 space-y-1">
                    ...
                    <li>
                        <a href="checkinout"
                            class="block rounded-lg px-4 py-2 text-sm font-medium {{ request()->is('checkinout') ? 'bg-gray-100 text-gray-700' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-700' }}">
                            Check-In/Check-Out
                        </a>
                    <li>
                        <a href="dtamu"
