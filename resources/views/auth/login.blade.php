...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        ...
        <form action="/login" method="POST">
            ...
            <button type="submit"
                class="w-full bg-indigo-600 text-white font-bold py-2 rounded-lg hover:bg-indigo-700">Masuk</button>
        </form>
        <a href="/" class="block text-center text-sm text-gray-500 mt-4 hover:text-indigo-600">Kembali ke
            Beranda</a>
    </div>
</body>
