<x-lplayout>
    ...
    <div class="relative z-10 min-h-screen pt-24 lg:pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-amber-900/10 p-6 lg:p-8 mb-8 border border-amber-100">
            ...
            @else
                <div class="flex flex-col sm:flex-row gap-5 items-center sm:items-start mb-8 text-center sm:text-left">
                    <div class="bg-amber-50 p-4 rounded-2xl shrink-0 border border-amber-100">
                ...
                <div class="max-w-md mx-auto sm:mx-0">
                    <a href="{{ route('login') }}"
                        class="block w-full text-center bg-amber-600 hover:bg-amber-700 text-white font-bold text-lg py-4 rounded-2xl shadow-lg shadow-amber-600/30 transition transform hover:-translate-y-0.5 border-none">
                        Log in atau daftar
                    </a>
                </div>
            @endauth
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-amber-200 overflow-hidden mb-8">
            ...
            @auth
                <a href="#"
                    class="flex items-center justify-between p-5 lg:p-6 border-b border-amber-100 hover:bg-amber-50/50 transition">
                    <div class="flex items-center gap-5">
                        <div class="bg-amber-50 p-3 rounded-xl shrink-0 border border-amber-100">
            ...
            <a href="#"
                class="flex items-center justify-between p-5 lg:p-6 hover:bg-amber-50/50 transition {{ Auth::check() ? 'border-b border-amber-100' : '' }}">
                <div class="flex items-center gap-5">
                    <div class="bg-amber-50 p-3 rounded-xl shrink-0 border border-amber-100">
                        <svg class="w-6 h-6 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
